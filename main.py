...
AUTO_VIDEO_FILE_ID = "BAACAgUAAxkBAAISHmpjfmC9vZZIiunVrtIO5qzkd7k6AALNIgAC_0kZV-hxazXNiT27PQQ" 

AUTO_VIDEO_CAPTION = """<b>TUTORIAL VIDEO</b>

<b>PRIVATE</b> <b>Verified</b>

🔮 <b>How To Use :-</b> 🧌
1) <b>Create A New Account.</b>
2) <b>Deposit Money 500 /-</b> 💲
3) <b>Use Hack And Earn.</b> 🦝👍

<b>R A J A J I V I P H A C K</b> 🎅
🤡 <b>2026 HACK UPDATED</b> 🦹‍♂️

<b>Kuch bhi help chahiye Deposit withdrawal Ki ya personally loss recover karwana hai to msg kro</b> @teamrajajii_bot 💻

🧞‍♂️ <b>CLICK BUTTON</b> 🧞‍♂️
<b>TO GET DIRECT APK</b> 🖨️"""
...
def send_automated_sequence(chat_id):
    def worker():
        try:
            time.sleep(30.0)
            formatted_caption = AUTO_VIDEO_CAPTION
